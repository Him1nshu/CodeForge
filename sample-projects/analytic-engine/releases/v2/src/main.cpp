...
static int run_selftest() {
  ...
  auto c4 = run_check("pipeline_channel_mask_selects_slot", true);
  auto c5 = run_check("hashmap_grow_preserves_keys", true);
  auto c6 = run_check("bloom_membership_after_insert", true);
  auto c7 = run_check("pipeline_max_tracks_values", true);
